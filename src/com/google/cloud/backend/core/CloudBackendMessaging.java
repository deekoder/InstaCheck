...
public class CloudBackendMessaging extends CloudBackendAsync {
    ...
    //ak-Sep15,2014
    public static final String USER_EMAIL_ADDRESS = "CloudBackendMessaging:UserEmailAddr";
    ...
    public CloudEntity createCloudMessage(String topicId) {
        CloudEntity ce = new CloudEntity(KIND_NAME_CLOUD_MESSAGES, USER_EMAIL_ADDRESS);
